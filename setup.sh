...
echo "2. Optional root shell: python3 -m venv .venv && source .venv/bin/activate && pip install -r requirements.txt"
echo "3. Project work: cd projects/<project-name> && make install && make ci"
echo "4. For local agent: cd projects/local-agent && ./scripts/start_local_agent.sh"
echo "5. Open dashboard: python3 -m http.server 8000 (then visit http://localhost:8000/docs/)"
echo ""
